...
from solarvibes.forms import FarmForm, NewCropForm, PreDateNewCropForm, PreNewCropForm, EditFarmForm, PreEditFarmForm # Manage Farms Forms
...
from solarvibes.forms import AddPumpForm, PreAddPumpForm # Manage Pumps Forms
